        ...
        <nav class="navbar navbar-expand navbar-dark  static-top" style="background: #0c5460">
            ...
            <ul class="navbar-nav ml-auto ml-md-0">
                ...
                <li class="nav-item dropdown no-arrow">
                    <a class="nav-link dropdown-toggle" href="admindeshboard" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <div class="dropdown-menu"  style="background:  #02a388"  aria-labelledby="pagesDropdown"> 
                        ...
                        <a class="dropdown-item" href="journalctrlpage"> General Journal</a>
                         <a class="dropdown-item" href="cashpayment"> Payment Voucher</a>
                          <a class="dropdown-item" href="cashrecived"> Received Voucher</a>
                    ...
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">
                                <a href="admindeshboard">Shortcut</a>
                            </li>
